...
namespace SKS
{
   ...
   partial class frmProviders
   {
      ...
      private static frmProviders m_vb6FormDefInstance { get; set; }
      ...
      [Intercepted]
      public Mobilize.Web.VBUC.ADODataControlHelper dcProviders { get; set; }
