...
refs["cmdProviders"]=_Mobilize_References[17];
refs["txtProviderName"]=_Mobilize_References[18];
...
const uint _Mobilize_Dirty_cmdProviders=(uint)1<<18;
const uint _Mobilize_Loaded_cmdProviders=(uint)1<<17;
const uint _Mobilize_Dirty_txtProviderName=(uint)1<<19;
const uint _Mobilize_Loaded_txtProviderName=(uint)1<<18;
...
[System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
private SKS.frmReceptionApproval m_vb6FormDefInstance_k__BackingField;
internal object m_vb6FormDefInstance {get
#line hidden
{if((_Mobilize_LoadedFlag_0&_Mobilize_Loaded_m_vb6FormDefInstance)<=0){this.m_vb6FormDefInstance_k__BackingField=Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetObservable<SKS.frmReceptionApproval>(this,_Mobilize_References,0);_Mobilize_LoadedFlag_0|=_Mobilize_Loaded_m_vb6FormDefInstance;;} return this.m_vb6FormDefInstance_k__BackingField; }set
#line hidden
{if(Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.SetObservable<SKS.frmReceptionApproval>(this,_Mobilize_References,0,this.m_vb6FormDefInstance_k__BackingField,(SKS.frmReceptionApproval)value)){_Mobilize_DirtyFlag_0|=_Mobilize_Dirty_m_vb6FormDefInstance;}_Mobilize_LoadedFlag_0|=_Mobilize_Loaded_m_vb6FormDefInstance;_Mobilize_ControlFlag|=_Mobilize_HasChanged_Flag;this.m_vb6FormDefInstance_k__BackingField=(SKS.frmReceptionApproval)value;}}
#line hidden
