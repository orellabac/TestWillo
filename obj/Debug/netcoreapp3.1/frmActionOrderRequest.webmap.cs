...
#line 1 "frmActionOrderRequest.cs"
#pragma warning disable
#line 1 "frmActionOrderRequest.cs"
...
if((_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtPromisedBy)>0)
{yield return "txtPromisedBy";
}
if((_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtRequiredBy)>0)
{yield return "txtRequiredBy";
}
...
if((_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtCustomerContact)>0)
...
case "txtPromisedBy":return (_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtPromisedBy)>0;
case "txtRequiredBy":return (_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtRequiredBy)>0;
...
case "txtCustomerContact":return (_Mobilize_DirtyFlag_0&_Mobilize_Dirty_txtCustomerContact)>0;
...
refs["txtPromisedBy"]=_Mobilize_References[3];
refs["txtRequiredBy"]=_Mobilize_References[4];
refs["txtReceivedBy"]=_Mobilize_References[5];
refs["cmdApprove"]=_Mobilize_References[6];
refs["txtStatus"]=_Mobilize_References[7];
refs["txtReceived"]=_Mobilize_References[8];
refs["txtChangedBy"]=_Mobilize_References[9];
refs["txtChanged"]=_Mobilize_References[10];
refs["txtOrderID"]=_Mobilize_References[11];
refs["txtNotes"]=_Mobilize_References[12];
refs["txtSubTotal"]=_Mobilize_References[13];
refs["txtTotal"]=_Mobilize_References[14];
refs["txtTotalTax"]=_Mobilize_References[15];
refs["txtFreightCharge"]=_Mobilize_References[16];
refs["txtSalesTax"]=_Mobilize_References[17];
refs["txtEntry"]=_Mobilize_References[18];
refs["fgDetails"]=_Mobilize_References[19];
refs["sbStatusBar_Panels_Panel1"]=_Mobilize_References[20];
refs["sbStatusBar"]=_Mobilize_References[21];
refs["cmdCancel"]=_Mobilize_References[22];
refs["cmdClose"]=_Mobilize_References[23];
refs["txtCustomerContact"]=_Mobilize_References[24];
refs["txtCustomerCompany"]=_Mobilize_References[25];
refs["Label5"]=_Mobilize_References[26];
refs["Label1"]=_Mobilize_References[27];
refs["Frame2"]=_Mobilize_References[28];
refs["Label13"]=_Mobilize_References[29];
refs["Label2"]=_Mobilize_References[30];
refs["Label7"]=_Mobilize_References[31];
refs["Label3"]=_Mobilize_References[32];
refs["Label19"]=_Mobilize_References[33];
refs["lblChangedBy"]=_Mobilize_References[34];
refs["Label4"]=_Mobilize_References[35];
refs["lblChanged"]=_Mobilize_References[36];
refs["Label12"]=_Mobilize_References[37];
refs["Label11"]=_Mobilize_References[38];
refs["Label10"]=_Mobilize_References[39];
refs["Label9"]=_Mobilize_References[40];
refs["Label8"]=_Mobilize_References[41];
refs["Label6"]=_Mobilize_References[42];
return refs;
}
...
var ref_txtPromisedBy=(Mobilize.WebMap.Common.Core.IObservable)this.txtPromisedBy;if(ref_txtPromisedBy!=null)yield return ref_txtPromisedBy;
var ref_txtRequiredBy=(Mobilize.WebMap.Common.Core.IObservable)this.txtRequiredBy;if(ref_txtRequiredBy!=null)yield return ref_txtRequiredBy;
...
const uint _Mobilize_Dirty_txtPromisedBy=(uint)1<<10;
const uint _Mobilize_Loaded_txtPromisedBy=(uint)1<<3;
const uint _Mobilize_Dirty_txtRequiredBy=(uint)1<<11;
const uint _Mobilize_Loaded_txtRequiredBy=(uint)1<<4;
const uint _Mobilize_Dirty_txtReceivedBy=(uint)1<<12;
const uint _Mobilize_Loaded_txtReceivedBy=(uint)1<<5;
const uint _Mobilize_Dirty_cmdApprove=(uint)1<<13;
const uint _Mobilize_Loaded_cmdApprove=(uint)1<<6;
const uint _Mobilize_Dirty_txtStatus=(uint)1<<14;
const uint _Mobilize_Loaded_txtStatus=(uint)1<<7;
const uint _Mobilize_Dirty_txtReceived=(uint)1<<15;
const uint _Mobilize_Loaded_txtReceived=(uint)1<<8;
const uint _Mobilize_Dirty_txtChangedBy=(uint)1<<16;
const uint _Mobilize_Loaded_txtChangedBy=(uint)1<<9;
const uint _Mobilize_Dirty_txtChanged=(uint)1<<17;
const uint _Mobilize_Loaded_txtChanged=(uint)1<<10;
const uint _Mobilize_Dirty_txtOrderID=(uint)1<<18;
const uint _Mobilize_Loaded_txtOrderID=(uint)1<<11;
const uint _Mobilize_Dirty_txtNotes=(uint)1<<19;
const uint _Mobilize_Loaded_txtNotes=(uint)1<<12;
const uint _Mobilize_Dirty_txtSubTotal=(uint)1<<20;
const uint _Mobilize_Loaded_txtSubTotal=(uint)1<<13;
const uint _Mobilize_Dirty_txtTotal=(uint)1<<21;
const uint _Mobilize_Loaded_txtTotal=(uint)1<<14;
const uint _Mobilize_Dirty_txtTotalTax=(uint)1<<22;
const uint _Mobilize_Loaded_txtTotalTax=(uint)1<<15;
const uint _Mobilize_Dirty_txtFreightCharge=(uint)1<<23;
const uint _Mobilize_Loaded_txtFreightCharge=(uint)1<<16;
const uint _Mobilize_Dirty_txtSalesTax=(uint)1<<24;
const uint _Mobilize_Loaded_txtSalesTax=(uint)1<<17;
const uint _Mobilize_Dirty_txtEntry=(uint)1<<25;
const uint _Mobilize_Loaded_txtEntry=(uint)1<<18;
const uint _Mobilize_Dirty_fgDetails=(uint)1<<26;
const uint _Mobilize_Loaded_fgDetails=(uint)1<<19;
const uint _Mobilize_Dirty_sbStatusBar_Panels_Panel1=(uint)1<<27;
const uint _Mobilize_Loaded_sbStatusBar_Panels_Panel1=(uint)1<<20;
const uint _Mobilize_Dirty_sbStatusBar=(uint)1<<28;
const uint _Mobilize_Loaded_sbStatusBar=(uint)1<<21;
const uint _Mobilize_Dirty_cmdCancel=(uint)1<<29;
const uint _Mobilize_Loaded_cmdCancel=(uint)1<<22;
const uint _Mobilize_Dirty_cmdClose=(uint)1<<30;
const uint _Mobilize_Loaded_cmdClose=(uint)1<<23;
const uint _Mobilize_Dirty_txtCustomerContact=(uint)1<<31;
const uint _Mobilize_Loaded_txtCustomerContact=(uint)1<<24;
const uint _Mobilize_Dirty_txtCustomerCompany=(uint)1<<32;
const uint _Mobilize_Loaded_txtCustomerCompany=(uint)1<<25;
const uint _Mobilize_Dirty_Label5=(uint)1<<33;
const uint _Mobilize_Loaded_Label5=(uint)1<<26;
const uint _Mobilize_Dirty_Label1=(uint)1<<34;
const uint _Mobilize_Loaded_Label1=(uint)1<<27;
const uint _Mobilize_Dirty_Frame2=(uint)1<<35;
const uint _Mobilize_Loaded_Frame2=(uint)1<<28;
const uint _Mobilize_Dirty_Label13=(uint)1<<36;
const uint _Mobilize_Loaded_Label13=(uint)1<<29;
const uint _Mobilize_Dirty_Label2=(uint)1<<37;
const uint _Mobilize_Loaded_Label2=(uint)1<<30;
const uint _Mobilize_Dirty_Label7=(uint)1<<38;
const uint _Mobilize_Loaded_Label7=(uint)1<<31;
const uint _Mobilize_Dirty_Label3=(uint)1<<39;
const uint _Mobilize_Loaded_Label3=(uint)1<<32;
const uint _Mobilize_Dirty_Label19=(uint)1<<40;
const uint _Mobilize_Loaded_Label19=(uint)1<<33;
const uint _Mobilize_Dirty_lblChangedBy=(uint)1<<41;
const uint _Mobilize_Loaded_lblChangedBy=(uint)1<<34;
const uint _Mobilize_Dirty_Label4=(uint)1<<42;
const uint _Mobilize_Loaded_Label4=(uint)1<<35;
const uint _Mobilize_Dirty_lblChanged=(uint)1<<43;
const uint _Mobilize_Loaded_lblChanged=(uint)1<<36;
const uint _Mobilize_Dirty_Label12=(uint)1<<44;
const uint _Mobilize_Loaded_Label12=(uint)1<<37;
const uint _Mobilize_Dirty_Label11=(uint)1<<45;
const uint _Mobilize_Loaded_Label11=(uint)1<<38;
const uint _Mobilize_Dirty_Label10=(uint)1<<46;
const uint _Mobilize_Loaded_Label10=(uint)1<<39;
const uint _Mobilize_Dirty_Label9=(uint)1<<47;
const uint _Mobilize_Loaded_Label9=(uint)1<<40;
const uint _Mobilize_Dirty_Label8=(uint)1<<48;
const uint _Mobilize_Loaded_Label8=(uint)1<<41;
const uint _Mobilize_Dirty_Label6=(uint)1<<49;
const uint _Mobilize_Loaded_Label6=(uint)1<<42;
